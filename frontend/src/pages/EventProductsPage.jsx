...
const EventProductsPage = () => {
  ...
  const [error, setError] = useState(null);
    ...
    const fetchEventProducts = async () => {
      try {
        setLoading(true);
        const response = await axios.get('/api/products/category/event-products');
      ...
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg border border-purple-200/30 overflow-hidden hover:shadow-purple-500/20 transition-all duration-500">
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 mb-4 line-clamp-2 leading-relaxed">{product.shortDescription}</p>
                     ...
                     <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-3 mb-4">
             <div className="space-y-2 text-sm">
               <div className="flex items-center justify-between">
                 <span className="text-orange-700 font-semibold">Suitable for:</span>
                 <span className="text-orange-600 font-medium">
                   {product.specifications?.find(spec => spec.name === 'Suitable for')?.value || 'Corporate Events'}
                 </span>
               </div>
               <div className="flex items-center justify-between">
                 <span className="text-orange-700 font-semibold">Customization:</span>
                 <span className="text-orange-600 font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-black text-gray-900">Event Products</h1>
              <p className="text-purple-600 font-semibold">Complete solutions for corporate events and gatherings</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-black text-gray-900 mb-6 text-center">Event Management Solutions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Event Materials</h3>
              <p className="text-gray-600">Complete kits for conferences, seminars, and corporate events</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <Gift size={24} className="text-white" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Swag & Gifts</h3>
              <p className="text-gray-600">Premium swag bags and gifts for event attendees</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Award Ceremonies</h3>
              <p className="text-gray-600">Professional materials for recognition and award events</p>
            </div>
          </div>
        </motion.div>
           ...
           {loading ? (
             ...
             <div className="text-center py-12">
               ...
               <button
                 ...
                 className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-2 rounded-xl font-bold transition-all duration-300"
               >
                 Try Again
               </button>
             </div>
             ...
             <div className="text-center py-12">
               ...
               <p className="text-gray-600">No event products are currently available.</p>
             </div>
           ) : (
