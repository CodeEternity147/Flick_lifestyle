...
const ClientProductsPage = () => {
  ...
  const [error, setError] = useState(null);
    ...
    const fetchClientProducts = async () => {
      try {
        setLoading(true);
        const response = await axios.get('/api/products/category/client-products');
          ...
          <p className="text-sm text-gray-600 mb-4 line-clamp-2 leading-relaxed">{product.shortDescription}</p>
             ...
             <div className="space-y-2 text-sm">
               <div className="flex items-center justify-between">
                 <span className="text-emerald-700 font-semibold">Suitable for:</span>
                 <span className="text-emerald-600 font-medium">
                   {product.specifications?.find(spec => spec.name === 'Suitable for')?.value || 'Client Appreciation'}
                 </span>
               </div>
               <div className="flex items-center justify-between">
                 <span className="text-emerald-700 font-semibold">Customization:</span>
                 <span className="text-emerald-600 font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-black text-gray-900">Client Products</h1>
              <p className="text-purple-600 font-semibold">Premium gifts and appreciation solutions for your clients</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-black text-gray-900 mb-6 text-center">Client Relationship Solutions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Client Appreciation</h3>
              <p className="text-gray-600">Show gratitude and strengthen client relationships</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <Handshake size={24} className="text-white" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Partnership Building</h3>
              <p className="text-gray-600">Foster long-term business partnerships</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">VIP Treatment</h3>
              <p className="text-gray-600">Premium gifts for your most valued clients</p>
            </div>
          </div>
        </motion.div>
           ...
           {loading ? (
             ...
             <div className="text-center py-12">
               ...
               <button
                 ...
                 className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-6 py-2 rounded-xl font-bold transition-all duration-300"
               >
                 Try Again
               </button>
             </div>
             ...
             <div className="text-center py-12">
               ...
               <p className="text-gray-600">No client products are currently available.</p>
             </div>
           ) : (
